...
install $SELINUX -D -m 755 -t "$DESTDIR$OPT_CNI_BIN_DIR" /opt/crio/cri-o/cni-plugins/*
...
sed -i 's;/opt/libexec;'"$DESTDIR$LIBEXECDIR"';g' "$DESTDIR$ETC_CRIO_DIR/crio.conf.d/10-crio.conf"
