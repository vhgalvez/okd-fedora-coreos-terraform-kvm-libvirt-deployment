...
# Create the storage pool for VM volumes
...
# Define the base volume with the Rocky Linux image
...
# Create the VM disk volumes based on the base image
...
# Define VM domains with boot order set correctly
